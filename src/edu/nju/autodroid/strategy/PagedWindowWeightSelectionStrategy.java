 ...
 */
public class PagedWindowWeightSelectionStrategy extends PagedWindowRandomSelectionStrategy {
    ...
    public PagedWindowWeightSelectionStrategy(IAndroidAgent androidAgent, int maxSteps, String startActivity, Logger actionLogger) {
