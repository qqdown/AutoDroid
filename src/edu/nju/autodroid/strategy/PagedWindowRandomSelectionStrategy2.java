 ...
 */
public class PagedWindowRandomSelectionStrategy2 extends SelectionStrategy<PagedWindow> {
    public PagedWindowRandomSelectionStrategy2(IAndroidAgent androidAgent, int maxSteps, String startActivity, Logger actionLogger) {
